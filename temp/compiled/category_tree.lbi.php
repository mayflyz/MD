...
?>
 ...
 <?php $_from = $this->_var['navigator_list']['middle']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_10220700_1494167956');$this->_foreach['nav_middle_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_middle_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_10220700_1494167956']):
        $this->_foreach['nav_middle_list']['iteration']++;
?>       
		<li <?php if ($this->_var['nav_0_10220700_1494167956']['active'] == 1): ?>class="this"<?php endif; ?>><a href="<?php echo $this->_var['nav_0_10220700_1494167956']['url']; ?>"><span title="<?php echo $this->_var['nav_0_10220700_1494167956']['name']; ?>"><?php echo $this->_var['nav_0_10220700_1494167956']['name']; ?></span></a></li>
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
