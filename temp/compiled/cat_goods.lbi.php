...
?>
                     ...
                     <li>
						...
						<p class="img"><a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank"><img src="<?php echo $this->_var['goods']['thumb']; ?>" alt="<?php echo $this->_var['goods']['goods_name']; ?>"/></a></p>
						<div class="txt">
						<p class="til"><a href="<?php echo $this->_var['goods']['url']; ?>" title="<?php echo $this->_var['goods']['goods_name']; ?>"><?php echo $this->_var['goods']['short_name']; ?></a></p>
						<p class="pri">
                <?php if ($this->_var['goods']['promote_price'] != ""): ?>
                <?php echo $this->_var['goods']['promote_price']; ?>
                <?php else: ?>
                ...
                <?php endif; ?>      
						...
						<p class="msg"><a href="<?php echo $this->_var['goods']['url']; ?>"><strong><?php echo $this->_var['goods']['comment_count']; ?></strong>人评论</a></p>
						</div>
						<div class="clear"></div>
					</li>
                    <?php endif; ?>                 
