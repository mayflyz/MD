...
?>
              <?php echo $this->_var['user_rank']['rank_name']; ?><span id="nrank_<?php echo $this->_var['user_rank']['rank_id']; ?>"></span><input type="text" id="rank_<?php echo $this->_var['user_rank']['rank_id']; ?>" name="user_price[]" value="<?php echo empty($this->_var['member_price_list']) ? '-1' : $this->_var['member_price_list']; ?>" onkeyup="if(parseInt(this.value)<-1){this.value='-1';};set_price_note(<?php echo $this->_var['user_rank']['rank_id']; ?>)" size="8" />
...
?>
          ...
          <!-- 首页推荐缩略图 qxfz.cn -->
          <tr id="auto_thumb_2">
            <td class="label">首页推荐缩略图：</td>
            <td id="auto_thumb_4">
              <input type="file" name="goods_thumb2" size="35" />
              <?php if ($this->_var['goods']['goods_thumb2']): ?>
                <a href="goods.php?act=show_image&img_url=<?php echo $this->_var['goods']['goods_thumb2']; ?>" target="_blank"><img src="images/yes.gif" border="0" /></a>
              <?php else: ?>
                <img src="images/no.gif" />
              <?php endif; ?>
            </td>
