...
?>
 <tr>
  <td width="18%" valign="top" class="first-cell">
    <input name="chkGroup" type="checkbox" value="checkbox" onclick="check('<?php echo $this->_var['priv']['priv_list']; ?>',this);" class="checkbox"><?php echo $this->_var['lang']; ?>
  </td>
  <td>
